...
import 'scss/admin/pages/css/login.css';
import 'scss/global/css/components-md.css';
import 'scss/global/css/plugins-md.css';
import 'scss/admin/layout/css/layout.css';
import 'scss/admin/layout/css/themes/default.css';
...
import 'scss/global/plugins/jquery-validation/js/jquery.validate.min.js';
import 'scss/global/scripts/metronic.js';
import 'scss/admin/layout/scripts/layout.js';
import 'scss/admin/layout/scripts/demo.js';
import 'scss/admin/pages/scripts/login.js';
...
class Login extends React.Component {
  ...
  return (
    ...
    <div className="logo">
        <h3 style={logoStyle}>PARSONS PROBLEMS</h3>
    </div>
    ...
    <div className="content">
        ...
        <form className="login-form" role="form">
            ...
            <div className="form-group">
                ...
                <label for="" className="control-label visible-ie8 visible-ie9">Username</label>
            ...
            <div className="form-group">
                <label for="" className="control-label visible-ie8 visible-ie9">Password</label>
            ...
            <div className="form-actions">
                <Link to="/dashboard/main" className="btn btn-success uppercase">Login</Link>

                <label for="" className="rememberme check">
        ...
        <form className="forget-form">
            ...
            <div className="form-actions">
                <button className="btn btn-default" id="back-btn" type="button">Back</button>
                <Link to="/dashboard/main" className="btn btn-success uppercase pull-right" type="submit">Submit</Link>
            </div>
        </form>
        ...
        <form className="register-form">
            ...
            <div className="form-group">
                <label for="" className="control-label visible-ie8 visible-ie9">First Name</label>
                <input type="text" className="form-control placeholder-no-fix" placeholder="First Name" name="fname"/>
            </div>

            <div className="form-group">
                <label for="" className="control-label visible-ie8 visible-ie9">Last Name</label>
                <input type="text" className="form-control placeholder-no-fix" placeholder="Last Name" name="lname"/>
            </div>

            <div className="form-group">
                <label for="" className="control-label visible-ie8 visible-ie9">Section #</label>
            ...
            <div className="form-group">
                <label for="" className="control-label visible-ie8 visible-ie9">Gender</label>
            ...
            <div className="form-group">
                <label for="" className="control-label visible-ie8 visible-ie9">Location</label>
            ...
            <div className="form-actions">
                <button id="register-back-btn" className="btn btn-default" type="button">Back</button>
                <Link to="/dashboard/main" id="register-submit-btn" className="btn btn-success uppercase pull-right" type="submit">Submit</Link>
            </div>
        </form>
